...
if [ "x$ZSH_VERSION" != x ]; then
	...
	case $var in
	PS1|PS2|HZ|TERM|SHELL|OLDPWD|PATH|MAIL|PWD|TZ|SHLVL|HOME|LOGNAME|PRINTER|HOST|HOSTNAME|HOSTTYPE|_|CC|CXX|EDITOR|SVN_EDITOR|SSH_*|DISPLAY|LESS*|LS_COLORS|LS_OPTIONS|TERMINFO|PAGER|MANPATH|VISUAL|http_proxy|https_proxy|ftp_proxy|XAUTHORITY|DBUS_*|SESSION_MANAGER|PKGBUILD_IPS_SERVER|PKGBUILD_SRC_IPS_SERVER|JDS_CBE_ENV_QUIET)
	    ;;
	*)
